...
class ShopApiController extends Controller
{
    ...
    // Cek ulang status pembayaran langsung ke Midtrans (dipanggil dari halaman Order Status),
    // supaya kalau webhook belum/tidak sampai, DB tetap ke-update pas user buka halaman ini.
    public function syncStatus(Request $request, Order $order, MidtransService $midtrans)
    {
        $order = $midtrans->syncOrderStatus($order);
        $order->load('payment', 'orderDetails.product');
